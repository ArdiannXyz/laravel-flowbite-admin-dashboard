...
<head>
    ...
    <style>
        ...
        td.right { text-align: right; color: #991b1b; font-weight: bold; }
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 16%;">Alasan / Keterangan</th>
            </tr>
        </thead>
        <tbody>
            @forelse($transaksi as $item)
                <tr>
                    ...
                    <td>{{ $item->rejection_reason ?? $item->notes ?? '-' }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="7" style="text-align: center;">Tidak ada riwayat barang keluar pada periode ini.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
