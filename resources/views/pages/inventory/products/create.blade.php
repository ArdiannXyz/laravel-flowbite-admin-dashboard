        ...
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" value="Dibuat otomatis saat produk disimpan" disabled
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: PRD-[KODE KATEGORI]-[NOMOR URUT]</p>
                </div>
