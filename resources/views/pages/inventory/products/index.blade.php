                            ...
                            <td class="px-6 py-4 text-right whitespace-nowrap">
                                <div class="flex items-center justify-end gap-2">
                                    ...
                                    @role('admin')
                                        ...
                                        <form action="{{ route('products.destroy', $product->id) }}" method="POST" data-confirm-delete="Apakah Anda yakin ingin menghapus produk '{{ $product->name }}'?" data-confirm-title="Hapus Produk" class="inline">
                                            @csrf
                                            @method('DELETE')
