            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" value="Dibuat otomatis saat supplier disimpan" disabled
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Format: SUP-[3 HURUF NAMA]-[NOMOR URUT]</p>
                    </div>
                    <div>
