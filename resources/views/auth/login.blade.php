...
<div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-3xl shadow-2xl p-8">
    ...
    <div class="lg:hidden text-center mb-8">
        ...
        <h1 class="mt-5 text-3xl font-bold text-gray-900 dark:text-white">Stockify</h1>
        <p class="text-sm text-gray-500 dark:text-gray-400 mt-2">Inventory Management System</p>
    </div>
    ...
    {{-- Error Login --}}
    @if ($errors->any())
        <div class="mb-6 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-700 dark:bg-red-900/30 dark:text-red-300">
            {{ $errors->first() }}
        </div>
    @endif
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div x-data="{ show: false }">
            ...
            <div class="relative">
                ...
                <input
                    ...
                    placeholder="••••••••"
                    class="w-full rounded-xl border border-gray-300 bg-gray-50 py-3 pl-11 pr-12 text-sm shadow-sm transition focus:border-emerald-500 focus:ring-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        ...
        <div class="flex items-center justify-between">
            ...
            @if (Route::has('password.request'))
                <a href="{{ route('password.request') }}" class="text-sm font-medium text-emerald-600 hover:underline">
                    Lupa Password?
                </a>
            @endif
        </div>
