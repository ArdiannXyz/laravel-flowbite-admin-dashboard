...
<div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-3xl shadow-2xl p-8">
    ...
    <div class="lg:hidden text-center mb-8">
        ...
        <h1 class="mt-5 text-3xl font-bold text-gray-900 dark:text-white">Buat Akun</h1>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6"
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input
                    ...
                    class="w-full rounded-xl border border-gray-300 bg-gray-50 py-3 pl-11 pr-4 text-sm shadow-sm focus:border-emerald-500 focus:ring-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
            </div>
        ...
        <button type="submit" :disabled="loading"
            ...
            <span x-show="loading" class="flex items-center justify-center gap-2">
                <svg class="animate-spin h-5 w-5" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M22 12A10 10 0 0012 2" stroke="currentColor" stroke-width="4" class="opacity-75" />
                </svg>
                Membuat Akun...
            </span>
        </button>
        ...
        <div class="text-center">
            <a href="{{ route('login') }}" class="text-sm font-medium text-emerald-600 hover:underline">
