...
<div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl border border-gray-200 dark:border-gray-700 rounded-3xl shadow-2xl p-8">
    ...
    <div class="lg:hidden text-center mb-8">
        ...
        <h1 class="mt-5 text-3xl font-bold text-gray-900 dark:text-white">Reset Password</h1>
    ...
    <div class="hidden lg:block mb-8">
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white">Buat Password Baru</h2>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-6"
        x-data="{ showPassword: false, showConfirm: false, loading: false }" @submit="loading = true">
        @csrf
        ...
        <div>
            ...
            <input
                ...
                class="w-full rounded-xl border border-gray-300 bg-gray-50 py-3 px-4 text-sm shadow-sm transition focus:border-emerald-500 focus:ring-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        ...
        <div>
            ...
            <div class="relative">
                <input
                    ...
                    placeholder="••••••••"
                    class="w-full rounded-xl border border-gray-300 bg-gray-50 py-3 px-4 pr-12 text-sm shadow-sm focus:border-emerald-500 focus:ring-emerald-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
        ...
        <button type="submit" :disabled="loading"
            ...
            <span x-show="loading" class="flex items-center justify-center gap-2">
                <svg class="animate-spin h-5 w-5" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M22 12a10 10 0 00-10-10" stroke="currentColor" stroke-width="4" class="opacity-75" />
                </svg>
                Memproses...
            </span>
        </button>
